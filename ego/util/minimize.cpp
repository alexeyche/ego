...
namespace NEgo {
	...
	TPair<TVectorD, double> Minimize(const TVectorD &X, TCallback f, TMinimizeConfig config) {
		TPair<double, TVectorD> fres = f(X);
		double f0 = fres.first;
		TVectorD df0 = fres.second;
