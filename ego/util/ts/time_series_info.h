...
#include <ego/protos/time_series_info.pb.h>
#include <ego/util/serial/proto_serial.h>
#include <ego/util/maybe.h>

namespace NEgo {

    struct TLabelInfo: public IProtoSerial<NEgoProto::TLabelInfo> {
        TLabelInfo() {}
    ...
    struct TLabelPos: public IProtoSerial<NEgoProto::TLabelPos> {
        TLabelPos() {}
    ...
    struct TTimeSeriesInfo: public IProtoSerial<NEgoProto::TTimeSeriesInfo> {
