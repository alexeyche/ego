...
#include <ego/protos/spikes_list.pb.h>
...
namespace NEgo {
    ...
    struct TSpikesListData : public IProtoSerial<NEgoProto::TSpikesListData> {
    ...
    struct TSpikesList : public IProtoSerial<NEgoProto::TSpikesList> {
