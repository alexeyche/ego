...
#include <ego/protos/time_series.pb.h>
#include <ego/util/ptr.h>
...
namespace NEgo {
    ...
    struct TTimeSeriesData : public IProtoSerial<NEgoProto::TTimeSeriesData> {
    ...
    struct TTimeSeries: public IProtoSerial<NEgoProto::TTimeSeries> {
        TTimeSeries() {}
