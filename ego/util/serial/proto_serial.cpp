...
namespace NEgo {
    ...
    bool TProtoSerial::operator() (TVectorD& v, int protoField) {
        ...
        switch (Mode) {
            case ESerialMode::IN:
            {
                const NEgoProto::TVectorD* vecProto = GetEmbedMessage<NEgoProto::TVectorD>(protoField);
            ...
            case ESerialMode::OUT:
            {
                NEgoProto::TVectorD* vecProto = GetEmbedMutMessage<NEgoProto::TVectorD>(protoField);
    ...
    bool TProtoSerial::operator() (TMatrixD& m, int protoField) {
        ...
        switch (Mode) {
            case ESerialMode::IN:
            {
                const NEgoProto::TMatrixD* mat = GetEmbedMessage<NEgoProto::TMatrixD>(protoField);
